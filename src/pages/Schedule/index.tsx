...
export default function Schedule () {
  ...
  const inputOwner = (e: any) => {
    ...
    const devices: {
        [key in DeviceTypes]: { [key in Brands]?: string[] };
    } = {
    ...
    const selectDeviceChange = (e: any) => {
            ...
            <form id='dados' name='dados' method='get' action=''>
              <div className='row mb-3'>
                ...
                <div className='col-md-4 my-3'>
                  ...
                  <select name='modelo' id='modelo' className='form-select' value={selectedModel} required>
